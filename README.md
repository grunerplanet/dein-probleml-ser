...
<body>
  ...
  <header class="header">
    <div class="container nav">
      <div class="logo">Dein PROBLEMLÖSER.</div>
  ...
  <section class="hero hero-first">
      <div class="container-header">
        ...
        <p>Waschmaschinen von Bosch, Siemens und vieles mehr.</p>
...
<h2 class="ideo">Co2 Emissionen eingesparrt</h2>
        <div id="counternew" data-target="85000">0</div>
...
<div class="slider-container">
  ...
  <div class="slider-track">
    ...
    <div class="slider-item">
      ...
      <img class="img" src="masch.png" alt="Produkt 1">
  ...
  <li>
    ...
    <div class="slider-item">
      <img class="img" src="masch.png" alt="Produkt 2">
      <h3>SIEMENS IQ700</h3>
      <ul class="icon-list">
  <li>
    <span class="icon">
  ...
  <li>
    ...
    <div class="slider-item">
      <img class="img" src="masch.png" alt="Produkt 3">
      <h3>Produkt 3</h3>
      <ul class="icon-list">
  <li>
    <span class="icon">
  ...
  <section id="cta" clas="cta">
         ...
         <div class="cont">
      <div class="box-left">
        <div class="content cover" id="magic-cover">
        </div>
      </div>
      <div class="box-right">
...
<p class="txt">so viel Emissionen eingesparrt.</p>
<div id="counternew" class="bg" data-target="85000">0</div>
        </div> 
  ...
  <section class="buchen">
    ...
    data-url="https://calendly.com/grunerplanet"
  ...
  <section id="service" class="hero">
    <div class="hero-container">
      ...
      <div class="hero-left">
        ...
        <img class="servicetechnik" src="service.png" alt="servicetechnik">
      </div>
      </div>
      ...
      <div class="hero-right">
        ...
        <h1 class="uberschrift">REFURBISHED.</h1>
        <h1 class="uberschrift">REFURBISHED.</h1>
         <img class="re" src="./1341372.svg" alt="">
      </div>
    ...
    <div class="hero-overlap">
      <div class="cont">
        <div class="box"><h4 class="marke">Bosch.<br>
          Siemens.<br>
        Miele.
        <br>
      BAUKNECHT <br>
      ...
      <img class="super" src="./superheldd.png" alt="">
        <div class="box">
          <div class="box-shadow">
<img class="sam" src="./sams-removebg-preview.png" alt="">
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="hero hero-sec">
    ...
    <div class="hero-right">
      ...
      <img class="pumpe" src="./pumpe.png" alt="">
      <img src="./schräg.svg" alt="" class="img">
    </div>
  </div>
